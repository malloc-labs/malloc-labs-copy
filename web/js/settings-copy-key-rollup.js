// Settings page — recent Copy > Key evidence rollup.

const root = document.getElementById("settings-copy-key-rollup");
const tbody = document.getElementById("settings-copy-key-rollup-tbody");
const metaEl = document.getElementById("settings-copy-key-rollup-meta");
const historyLink = document.getElementById("settings-copy-key-history-link");
...
async function loadRollup() {
    try {
        const res = await fetch("/api/copy-key-band-evidence", { cache: "no-store" });
